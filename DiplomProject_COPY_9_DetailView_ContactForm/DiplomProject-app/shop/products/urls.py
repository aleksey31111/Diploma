...
urlpatterns = [
    ...
    path('products/detail_view', views.detail_view, name="detail_view"),
    # path('products/product/<int:pk>/', views.detail_view, name='detail_view'),
    # path('products/product/<int:pk>/', views.detail, name='detail'),
