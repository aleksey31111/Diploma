...
class Basket(models.Model):
    ...
    product_ProfitableProposition = models.ForeignKey(ProfitableProposition, on_delete=models.CASCADE)
    ...
    def __str__(self):
        ...
        # return f'Корзина для {self.user.username} |\
    # Продукт {self.product.name if self.product.name else self.product_ProfitableProposition.name }'
